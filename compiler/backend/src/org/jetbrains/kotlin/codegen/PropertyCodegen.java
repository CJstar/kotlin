...
public class PropertyCodegen {
    ...
    private boolean generateBackingField(
        ...
        if (isJvmInterface(descriptor.getContainingDeclaration()) || kind == OwnerKind.INTERFACE_IMPL) {
            return false;
        }
    ...
    private void generateSyntheticMethodIfNeeded(@NotNull PropertyDescriptor descriptor, Annotations annotations) {
        ...
        if (!isInterface(context.getContextDescriptor()) || kind == OwnerKind.INTERFACE_IMPL) {
            ...
            Type tImplType = typeMapper.mapInterfaceImpl((ClassDescriptor) context.getContextDescriptor());
